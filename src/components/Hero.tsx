...
const Hero = () => {
  ...
  return (
    <section id="home" className="min-h-screen flex flex-col justify-between relative bg-gradient-to-br from-slate-900 via-purple-900 to-slate-900 animate-gradient-xy overflow-hidden">
