...
const Hero = () => {
  ...
  return (
    <section id="home" className="min-h-screen flex flex-col items-start justify-between relative bg-gradient-to-br from-slate-900 via-purple-900 to-slate-900 animate-gradient-xy overflow-hidden">
      ...
      <div className="w-full max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pt-20 relative">
      ...
      <div className="w-full max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pb-20 mt-auto">
